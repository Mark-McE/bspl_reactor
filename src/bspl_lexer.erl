...
yystate(31, [10|Ics], Line, Tlen, _, _) ->
    yystate(31, Ics, Line+1, Tlen+1, 12, Tlen);
...
yystate(29, [113|Ics], Line, Tlen, Action, Alen) ->
...
yystate(29, [109|Ics], Line, Tlen, Action, Alen) ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
yystate(29, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 104 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/bspl_lexer.xrl", 7).
yyaction_0(TokenLine) ->
     { token, { role, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/bspl_lexer.xrl", 8).
yyaction_1(TokenLine) ->
     { token, { parameter, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/bspl_lexer.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { key, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/bspl_lexer.xrl", 10).
yyaction_3(TokenLine) ->
     { token, { '->', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/bspl_lexer.xrl", 11).
yyaction_4(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/bspl_lexer.xrl", 12).
yyaction_5(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/bspl_lexer.xrl", 13).
yyaction_6(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/bspl_lexer.xrl", 14).
yyaction_7(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/bspl_lexer.xrl", 15).
yyaction_8(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/bspl_lexer.xrl", 16).
yyaction_9(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_10/2}).
-file("src/bspl_lexer.xrl", 17).
yyaction_10(TokenChars, TokenLine) ->
     { token, { adornment, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_11/2}).
-file("src/bspl_lexer.xrl", 18).
yyaction_11(TokenChars, TokenLine) ->
     { token, { word, TokenLine, list_to_bitstring (TokenChars) } } .

-compile({inline,yyaction_12/0}).
-file("src/bspl_lexer.xrl", 19).
yyaction_12() ->
     skip_token .
